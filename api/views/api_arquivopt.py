...
def get_domains():
    ...
    # Handle request
    result = handlers_arquivopt.get_domains()
...
def get_examples():
    ...
    # Handle request
    result = handlers_arquivopt.get_examples()
...
def get_events():
    ...
    result = handlers_arquivopt.get_events(payload)
...
def get_titles():
    ...
    result = handlers_arquivopt.get_titles(payload)
...
def get_entities_terms():
    ...
    result = handlers_arquivopt.get_entities_terms(payload)
...
def get_timeseries():
    ...
    result = handlers_arquivopt.get_timeseries(payload)
